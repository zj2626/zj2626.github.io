...
　　{% asset_img 201112231832078695.png 哈夫曼树 %}
    
    　  虚线为新生成的结点，第二步再把新生成的权值为3的结点放到剩下的集合中，所以集合变成{5,4,3,3}，再根据第二步，取最小的两个权值构成新树，如图：
    
　　{% asset_img 201112231832087092.png 哈夫曼树 %}
    
        再依次建立哈夫曼树，如下图：
    
　　{% asset_img 201112231832084301.jpg 哈夫曼树 %}
    
        其中各个权值替换对应的字符即为下图：
        
　　{% asset_img 201112231832086286.jpg 哈夫曼树 %}

        如下图也可以加深大家的理解：

　　{% asset_img 272122409653995.gif 哈夫曼树 %}
