...
{% asset_img jenkins_a.png 图片标题 %}

{% asset_img jenkins_b.png 图片标题 %}

*如果项目是私有的项目(如码云中的), 则需要设置用户名密码--在 Credentials 中配置 Add 一个*
{% asset_img jenkins_c.png 图片标题 %}

{% asset_img jenkins_maven.png 图片标题 %}
...
{% asset_img jenkins_maven2.png 图片标题 %}
...
{% asset_img blog_jenkins.png 图片标题 %}
