...
![项目目录文件](http://okow3aoov.bkt.clouddn.com/1.png)
...
![](http://okow3aoov.bkt.clouddn.com/2.png)

> 输入正确的用户名(ay2626)密码 点击登录 成功; 再次输入地址 http://localhost:8080/home 跳转到成功的jsp

![](http://okow3aoov.bkt.clouddn.com/3.png)
...
![](http://okow3aoov.bkt.clouddn.com/5.png)
...
![](http://okow3aoov.bkt.clouddn.com/40.png)
