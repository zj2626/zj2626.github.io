...
![项目目录文件](http://okoo87hee.bkt.clouddn.com/1.png)
...
```aidl
    ...
    <web-app xmlns="http://xmlns.jcp.org/xml/ns/javaee"
        ...
        <!--两个servlet配置   /login跳转到登陆页面  /home跳转到主页,即登陆成功页面-->
        <servlet>
...
##### *1.authc.loginUrl配置身份认证不通过(未登录时)跳转的地址*
##### *2.[users]下配置用户身份信息以及用户角色*
##### *3.[roles]下配置角色以及角色的控制权限*
##### *4.[urls]下配置访问地址所需的权限, 其中"anon过滤器"表示地址不需要登录即可访问; "authc过滤器"表示地址登录才能访问*
...
![](http://okoo87hee.bkt.clouddn.com/2.png)

> 输入正确的用户名密码 点击登录 成功; 再次输入地址 http://localhost:8080/home 跳转到成功的jsp

![](http://okoo87hee.bkt.clouddn.com/3.png)
